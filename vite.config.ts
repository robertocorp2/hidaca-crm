...
function localBindingConfig(includeLocalFeatureDefaults: boolean) {
  return {
  main: "./worker/index.ts",
  compatibility_flags: ["nodejs_compat"],
  // Sites injects production flags at deploy time. Shipping these local
  // defaults in the worker manifest would override that runtime injection.
  ...(includeLocalFeatureDefaults
    ? {
        vars: {
